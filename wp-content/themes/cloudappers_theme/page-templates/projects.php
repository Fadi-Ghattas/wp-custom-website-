                        ...
                        <div class="filters-container">
                            <ul class="filters">
                                <li class="active">
                                    <a href="#">
                                        <img class="icon"
                                             src="<?php echo esc_url(get_stylesheet_directory_uri() . '/img/all-icon.png'); ?>">
                                        <img class="icon-hover"
                                             src="<?php echo esc_url(get_stylesheet_directory_uri() . '/img/all-icon.hover.png'); ?>">
                                        ALL
                                    </a>
                                </li>
                                ...
                                <?php foreach ($projectTypes as $projectType) { ?>
                                    <li><a href="#"
                                           data-type=".<?php echo str_replace(' ', '_', strtolower($projectType['post_title'])); ?>">
                                            <img class="icon"
                                                 src="<?php echo esc_url($projectType['project_type_icon']['url']); ?>">
                                            <img class="icon-hover"
                                                 src="<?php echo esc_url($projectType['project_type_icon_on_hover']['url']); ?>">
