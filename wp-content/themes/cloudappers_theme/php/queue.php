...
//	}
	wp_enqueue_style('layout', get_template_directory_uri() . '/css/custom/default-style.css', [], '4.94');
...
//	}
	...
	wp_enqueue_script('theme_js', get_template_directory_uri() . '/js/custom/theme.js', ['jquery-min'], '1.20', TRUE);
