...
function project_scripts()
{
	...
	wp_enqueue_style('layout', get_template_directory_uri() . '/css/custom/default-style.css', [], '1.24');
...
//	wp_enqueue_script('helpers_js', get_template_directory_uri() . '/js/custom/helpers.js', ['jquery-min'], '1.0', FALSE);
	wp_enqueue_script('css_js', get_template_directory_uri() . '/js/custom/css.js', ['jquery-min'], '1.10', FALSE);
