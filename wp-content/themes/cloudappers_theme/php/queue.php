...
//	}
	wp_enqueue_style('layout', get_template_directory_uri() . '/css/custom/default-style.css', [], '5.28');
...
//	}
	...
	wp_enqueue_script('css_js', get_template_directory_uri() . '/js/custom/css.js', ['jquery-min'], '2.8', FALSE);
